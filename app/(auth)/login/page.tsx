        ...
        <div style={{
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <p style={{ fontSize: '14px', color: 'var(--body)', margin: 0 }}>
              Sign in to your OPEN360 workspace.
            </p>
          </div>
          ...
          <button
            ...
            onMouseOver={e => { if (!loading) e.currentTarget.style.background = 'var(--canvas-soft)' }}
            onMouseOut={e => { if (!loading) e.currentTarget.style.background = 'var(--canvas)' }}
          >
            {loading ? (
              <>
