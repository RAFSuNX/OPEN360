    ...
    <div style={{ minHeight: '100vh', background: 'var(--canvas)' }}>
      <nav style={{
        ...
        <div style={{ textAlign: 'right' as const }}>
          <p style={{ fontSize: '12px', color: 'var(--ink)', margin: 0, fontFamily: "'JetBrains Mono', monospace" }}>
            {session.user.email}
          </p>
          <p style={{ fontSize: '10px', fontWeight: '600', letterSpacing: '0.88px', textTransform: 'uppercase' as const, color: 'var(--primary)', margin: 0 }}>
            Admin
          </p>
        </div>
      </nav>
